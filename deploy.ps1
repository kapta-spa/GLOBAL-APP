...
Write-Host "2. Obteniendo URL remota del proyecto principal..." -ForegroundColor Green
$remoteUrl = git -C "$PSScriptRoot" remote get-url origin

Write-Host "3. Preparando despliegue de la carpeta dist..." -ForegroundColor Green
...
Write-Host "4. Enviando contenido de dist a la rama main de GitHub..." -ForegroundColor Green
